...
class ComposerStaticInitc92fa0c3279eec61688eaa42f87dcf2c
{
    ...
    public static $classMap = array (
        ...
        'MockAction' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/MockAction.php',
        'MockPHPMailer' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/MockPHPMailer.php',
        ...
        'Rosio\\WordPressTestingHarness\\Bootstrapper' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Bootstrapper.php',
        ...
        'TestXMLParser' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/TestXMLParser.php',
        ...
        'TracTickets' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/TracTickets.php',
        'UnhandledMatchError' => __DIR__ . '/..' . '/symfony/polyfill-php80/Resources/stubs/UnhandledMatchError.php',
        'ValueError' => __DIR__ . '/..' . '/symfony/polyfill-php80/Resources/stubs/ValueError.php',
        'WPAjaxDieContinueException' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Exceptions/WPAjaxDieContinueException.php',
        'WPAjaxDieStopException' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Exceptions/WPAjaxDieStopException.php',
        'WPDieException' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Exceptions/WPDieException.php',
        'WPProfiler' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/WPProfiler.php',
        'WP_Ajax_UnitTestCase' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/WP_Ajax_UnitTestCase.php',
        'WP_Image_Editor_Mock' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/WP_Image_Editor_Mock.php',
        'WP_Tests_Exception' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Exceptions/WP_Tests_Exception.php',
        'WP_UnitTestCase' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/WP_UnitTestCase.php',
        'WP_UnitTest_Factory' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Factory.php',
        'WP_UnitTest_Factory_Callback_After_Create' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Factory_Callback_After_Create.php',
        'WP_UnitTest_Factory_For_Attachment' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Factory_For_Attachment.php',
        'WP_UnitTest_Factory_For_Blog' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Factory_For_Blog.php',
        'WP_UnitTest_Factory_For_Comment' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Factory_For_Comment.php',
        'WP_UnitTest_Factory_For_Post' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Factory_For_Post.php',
        'WP_UnitTest_Factory_For_Term' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Factory_For_Term.php',
        'WP_UnitTest_Factory_For_Thing' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Factory_For_Thing.php',
        'WP_UnitTest_Factory_For_User' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Factory_For_User.php',
        'WP_UnitTest_Generator_Sequence' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/Factories/WP_UnitTest_Generator_Sequence.php',
        'WP_XMLRPC_UnitTestCase' => __DIR__ . '/..' . '/rosio/wordpress-testing-harness/src/WP_XMLRPC_UnitTestCase.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitc92fa0c3279eec61688eaa42f87dcf2c::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitc92fa0c3279eec61688eaa42f87dcf2c::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInitc92fa0c3279eec61688eaa42f87dcf2c::$classMap;
